...
export class myInit1580389732510 implements MigrationInterface {
    name = 'myInit1580389732510';
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "mission" ADD "createDateTime" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT TIMESTAMP`, undefined);
        // tslint:disable-next-line:max-line-length
        await queryRunner.query(`ALTER TABLE "mission" ADD "lastChangedDateTime" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT TIMESTAMP`, undefined);
